...
export const QUOTE = {
  ...
  */
  ...
  /*
    ...
    규격과 다르다. **규격은 물건이 무엇인가**이고, **비고는 이 견적에서 그 줄이
    무슨 구실인가**다(「서버 새시」「64코어」「Raid5」). 우리 양식에 원래 있던 열인데
    담을 칸이 없어 읽어도 버려졌다(사용자 지적 2026-09-21: 「비고는 왜 없는거야」).
  */
  lineRemark: '비고',
  lineRemarkPlaceholder: '예: 서버 새시, 64코어, Raid5',
