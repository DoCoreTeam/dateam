 ...
 * 5. **분류의 크기는 배지가 아니다.** 배지는 눌러서 없앨 것을 센다 — 안 한 점검, 안 쓴 보고서.
 *    퇴사자 수·전체 회원 수처럼 보고 나도 그대로 남는 숫자를 배지로 달면
 *    **영원히 안 꺼지는 알림**이 된다(사용자 지적 2026-09-19: 「확인했으면 없어져도 되잖아」).
 *    그런 숫자는 그 화면에 들어갔을 때 제목 옆에 적는다.
 *
