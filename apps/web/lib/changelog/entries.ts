...
export const CHANGELOG: ChangelogNote[] = [
  {
    version: '0.7.449', date: '2026-08-12', title: '목록 화면이 내가 본 그대로 저장되고 공유돼요',
    items: [
      { kind: 'improve', emoji: '🔗', headline: '검색·정렬·보기 상태가 주소에 담겨요', detail: '새로고침해도 조건이 그대로 남고, 링크를 복사해 보내면 상대도 같은 화면을 봅니다. 담당자·거래처 목록에 먼저 적용했고 나머지 목록으로 넓혀갈게요.' },
