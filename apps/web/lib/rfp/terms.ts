...
export const RFP_RADAR = {
  title: '공고 레이더',
  desc: '나라장터에서 조건에 맞는 새 공고를 찾아 둡니다. 케이스로 만드는 것은 직접 고릅니다',
  rules: '찾을 조건',
  addRule: '조건 추가',
  askTitle: '어떤 공고를 찾을까요',
  ...
  reviewHint: '맞으면 저장하고, 아니면 고쳐서 저장하세요',
  editManually: '직접 적기',
  ruleName: '조건 이름',
  keywords: '키워드',
  budgetRange: '예산 범위',
  agencies: '기관',
  sweepNow: '지금 찾아보기',
  sweepDesc: '나라장터에서 최근 공고를 가져와 조건에 맞는 것만 고릅니다',
  collected: '새로 가져온 공고',
  matched: '조건에 걸린 공고',
  noServiceKey: '나라장터 서비스 키가 없어 새 공고를 못 가져왔습니다',
  noRules: '조건이 없어 고를 수 없습니다',
  noCondition: '조건을 하나 이상 넣어 주세요 (키워드·기관·예산)',
  nameRequired: '조건 이름을 적어 주세요',
  agencies2: '발주 기관',
  budgetMin: '예산 하한',
  budgetMax: '예산 상한',
  ...
  adoptNoFiles: '받을 첨부가 없어 파일을 직접 올려야 합니다',
  /** 금액 단위 — 원 단위 열한 자리는 사람이 못 읽는다 */
  unitEok: '억',
  unitMan: '만',
  hits: '찾은 공고',
  score: '사전 점수',
...
export const RFP_ADMIN = {
  title: '설정',
  /*
    분류 탭 — 카드 여섯을 한 줄로 늘어놓지 않는다.
    무엇을 고치러 왔든 여섯 장을 다 지나가야 했고, 카드가 늘 때마다 그 길이 길어진다.
  */
  tabUsage: '사용량',
  tabAi: 'AI와 규칙',
  tabData: '연동과 기록',
