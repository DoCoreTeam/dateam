    ...
    <html lang="ko">
      <body style={{
        ...
        <main style={{ maxWidth: '32rem', padding: 'var(--space-8)', textAlign: 'center' }}>
          ...
          {/*
            **아무에게도 알림이 가지 않는다** — `system_events` 에 한 줄 남길 뿐이다.
            사람에게 무언가 도착한다고 말하면 사용자는 기다리고, 아무것도 안 오면
            화면의 다른 말까지 못 믿게 된다(관리자 본인이 "나에게 온 알림이 없는데?" 라고 물었다).
          */}
          <p style={{ margin: `0 0 var(--space-6)`, lineHeight: 1.7, color: 'var(--text-muted)' }}>
            무슨 일이 있었는지 시스템 로그에 남겼어요.
