    ...
    <div>
      ...
      <div className="card" style={{ maxWidth: '480px', padding: 'var(--space-6)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
          ...
          {data.notes && (
            <div style={{ marginTop: '0.5rem', paddingTop: 'var(--space-4)', borderTop: 'var(--border-w-2) solid var(--border-color)' }}>
              <p style={{ fontSize: 'var(--fs-base)', color: 'var(--text)', margin: 0, lineHeight: 1.6 }}>{data.notes}</p>
            </div>
          )}
