    ...
    <div className="card" style={{ padding: 'var(--space-6)', maxWidth: '640px' }}>
      ...
      >
        ...
        <div>
          ...
          >
            {cardUploading ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-2)', color: 'var(--text-faint)' }}>
                <Loader2 size={20} style={{ animation: 'spin 1s linear infinite' }} />
                <span style={{ fontSize: 'var(--fs-xs)' }}>업로드 중...</span>
              </div>
            ) : cardPreviewUrl ? (
              <>
                ...
                >
                  <ImageOff size={18} />
                  <span style={{ fontSize: 'var(--fs-xs)' }}>미리보기 불가</span>
                </div>
                <div
                  style={{
                    position: 'absolute',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.375rem', color: 'var(--text-faint)' }}>
                <Camera size={20} />
                <span style={{ fontSize: 'var(--fs-xs)' }}>클릭하여 업로드</span>
                <span style={{ fontSize: 'var(--fs-2xs)', color: 'var(--border-subtle)' }}>이미지, 최대 10MB</span>
              </div>
            )}
          </div>
          {cardUploadError && (
            <p style={{ color: 'var(--danger)', fontSize: 'var(--fs-sm)', margin: '0.375rem 0 0 0' }}>{cardUploadError}</p>
          )}
        </div>
