    ...
    >
      <div style={{
        ...
        <h2
          ...
          style={{ fontSize: '1.375rem', fontWeight: 700, color: 'var(--text)', margin: '0 0 0.625rem', letterSpacing: '-0.03em' }}
        >
          오늘이 금요일이에요!
        </h2>
        ...
        <Link
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, var(--brand-dark) 0%, var(--brand) 60%, var(--brand) 100%)',
            color: 'white',
