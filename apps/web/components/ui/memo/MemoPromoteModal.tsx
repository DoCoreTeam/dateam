    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
          <div style={{ fontSize: '0.82rem', color: '#475569', background: '#f8fafc', borderRadius: '0.5rem', padding: '0.6rem 0.75rem', lineHeight: 1.5 }}>
            {memo.content}
          </div>
          ...
          <label style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            ...
            <input type="date" value={targetDate} onChange={(e) => setTargetDate(e.target.value)}
              style={{ padding: '0.5rem 0.75rem', border: '1px solid #cbd5e1', borderRadius: '0.5rem', fontSize: '0.875rem' }} />
          </label>
